		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.#", fmt.Sprintf("%d", 1)),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.message", cdn.ObjectProperty.Message),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.detailed_message", cdn.ObjectProperty.DetailedMessage),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.example_int", fmt.Sprintf("%d", cdn.ExampleInt)),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.example_number", floatToString(cdn.ExampleNumber)),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.example_boolean", "true"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_nested_scheme_property.0.object_property.0.account", cdn.ObjectNestedSchemeProperty.ObjectProperty.Account),
					resource.TestCheckResourceAttr(
...
resource "%s" "my_cdn" {}`, providerName, openAPIResourceNameCDN)
	...
	expectedValidationError, _ := regexp.Compile(".*The argument \"apikey_auth\" is required, but no definition was found.*")
	resource.Test(t, resource.TestCase{
		PreCheck:          func() { testAccPreCheck(t) },
		ProviderFactories: testAccProviders,
		CheckDestroy:      testCheckCDNsV1Destroy,
...
resource "%s" "my_cdn" {
  ...
  hostnames = ["%s"]
	...
	expectedValidationError, _ := regexp.Compile(".*The argument \"label\" is required, but no definition was found.*")
	resource.Test(t, resource.TestCase{
		PreCheck:          func() { testAccPreCheck(t) },
		ProviderFactories: testAccProviders,
		CheckDestroy:      testCheckCDNsV1Destroy,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.#", fmt.Sprintf("%d", 1)),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.message", cdnUpdated.ObjectProperty.Message),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.detailed_message", cdnUpdated.ObjectProperty.DetailedMessage),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.example_int", fmt.Sprintf("%d", cdnUpdated.ExampleInt)),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.example_number", floatToString(cdnUpdated.ExampleNumber)),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.example_boolean", "false"),
					...
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_nested_scheme_property.0.object_property.#", fmt.Sprintf("%d", 1)),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_nested_scheme_property.0.object_property.0.account", cdnUpdated.ObjectNestedSchemeProperty.ObjectProperty.Account),
...
func TestAccCDN_UpdateImmutableProperty(t *testing.T) {
	...
	expectedValidationError, _ := regexp.Compile("Error: validation for immutable properties failed: user attempted to update an immutable property \\('label'\\): \\[user input: label updated; actual: someLabel\\]. Update operation was aborted; no updates were performed")
	resource.Test(t, resource.TestCase{
		PreCheck:          func() { testAccPreCheck(t) },
		ProviderFactories: testAccProviders,
		CheckDestroy:      testCheckCDNsV1Destroy,
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.#", fmt.Sprintf("%d", 1)),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.message", cdnUpdatedForceNew.ObjectProperty.Message),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.detailed_message", cdnUpdatedForceNew.ObjectProperty.DetailedMessage),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.example_int", fmt.Sprintf("%d", cdnUpdatedForceNew.ExampleInt)),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.example_number", floatToString(cdnUpdatedForceNew.ExampleNumber)),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_property.0.example_boolean", "true"),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_nested_scheme_property.#", fmt.Sprintf("%d", 1)),
					...
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_nested_scheme_property.0.object_property.#", fmt.Sprintf("%d", 1)),
					resource.TestCheckResourceAttr(
						openAPIResourceStateCDN, "object_nested_scheme_property.0.object_property.0.account", cdnUpdatedForceNew.ObjectNestedSchemeProperty.ObjectProperty.Account),
					resource.TestCheckResourceAttr(
